 ...
 */
class Imttransaction extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('sim_users_id,amount,mobile_no,country_id', 'required'),
			array('id,country_id,sim_users_id', 'numerical', 'integerOnly'=>true),	

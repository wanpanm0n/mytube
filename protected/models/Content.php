...
class Content extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('category_id, title, title_unicode, user_id, language_id, link, delete_status, duration', 'required'),
			array('user_id, language_id, category_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, title, title_unicode, description, image, duration, cast, user_id, language_id, category_id, created_date, modified_date', 'safe', 'on'=>'search'),
		);
	}

	...
	'attributes'=>array(
		...
		//'image',
			array(
					'name'=>'image',
					'type'=>'raw',
					'value'=>CHtml::image($this->imagePath().$model->category_id.'/'.$model->image),
...
<div class="col-md-4">
	<div class="panel panel-default">
		...
		<ul class="list-group">
		  ...
		  <li class="list-group-item"><a href="<?php echo Yii::app()->createUrl('content/update',array('id'=>$model->id)); ?>">Update Content</a></li>

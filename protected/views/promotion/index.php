...
<div class="row">
	<div class="col-lg-12">
		...
		<a href="/promotion/create" class="btn btn-default">Add</a>
    </div>
</div>
...
<script>
	...
	$(function(){
		...
		$.ajax({url : "/promotion/select",method : "POST",
		beforeSend: function (xhr) {
                        ...
                        columns: [
                            ...
                            { field: "FromDate", title: "FromDate"},
                            { field: "ToDate", title: "ToDate"},
                            { field: "IsActive", width: "130px" ,template:function(data){ return data.IsActive ? "Yes" : "No"}},
							{ field: "DisplayOrder", title: "Order",filterable : false, sortable: false},
							{ width: "130px",
					...
					function searchRow(e){
						...
						window.location.href="/promotion/update/id/"+item.Id;
						}
						...
						bootbox.confirm("Are you sure want to delete?",function(r){
							...
							if(r){
								...
								var item = kendoGrid.dataItem($(e.target).closest("tr"));
								 ...
								 $.ajax({url : "/promotion/delete", method : "POST", data : {

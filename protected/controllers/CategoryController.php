...
// 		$model_language = Language::model()->findAll();
	...
	public function actionDelete($id)
	{
		...
		try {
			if($content->count('category_id=:cid and delete_status=0', array(':cid'=>$id))>0){
				if (!$content->updateAll(array('delete_status' => 1),'category_id=:cid and delete_status=0', array(':cid'=>$id))) 

<div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Manage News</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
<div class="col-md-9">
	...
	'columns'=>array(
		...
		//'title',
			array(
					'name' => 'title',
					'type'=>'raw',
					'value' => 'CHtml::link(UHtml::markSearch($data,"title"),array("news/view","id"=>$data->id))',
			),
			'title_unicode',
// 			array(
...
// 			),
			...
			array(
					...
					'filter'=>'',
					'type'=>'raw',
					'value'=>'(!empty($data->image))?CHtml::image(Yii::app()->request->baseUrl."/uploads/news/".$data->image,"",array("style"=>"max-height:100px")):""',

<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo  UserModule::t('Update User')." ".$model->id; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
...
$this->widget('zii.widgets.CMenu', array(
    ...
    array('label'=>UserModule::t('View User'), 'url'=>array('view','id'=>$model->id),'itemOptions'=>array('class' => 'list-group-item')),
